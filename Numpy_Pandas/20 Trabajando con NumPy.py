...
np.linspace(0,10,4)  #El intervalo viene definido por el número 4.  
...
"""
Indexado de fila 1.  Ojo, la fila 1 es la segunda fila del array.  
...
#____________________________________
"""
son funciones que operan de manera elemento por elemento en arrays de NumPy, 
